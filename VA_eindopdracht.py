...
df_coffee_exploded['ingredients'] = df_coffee_exploded['ingredients'].str.replace('Coffee2001', 'Coffee')
df_coffee_exploded['ingredients'] = df_coffee_exploded['ingredients'].str.replace('Coffee2002', 'Coffee')
